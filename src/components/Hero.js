    ...
    if (isWidthDown('md', this.props.width) && isWidthUp('sm', this.props.width)) {
      return (
        <div className="hero" style={{height: '42em'}}>
          ...
          <img className="nav-logo" src={require('../assets/logo.png')}></img>
            ...
            <Grid container spacing={24}>
              <Grid item xs={12} sm={7} md={7} lg={7} xl={7} style={{paddingTop: '90px'}}>
                ...
                <div style={{margin: '50px 0'}}>
                  <input className="hero-input" placeholder="Book your training"></input>
                  <Button variant="contained" className="hero-button">Join a Group</Button>
                </div>
              </Grid>
              <Grid item xs={12} sm={5} md={5} lg={5} xl={5}>
                <img className="hero-image" style={{height: '550px', width: 'auto'}} src={require('../assets/khalil-transparent.png')}></img>
              </Grid>
            </Grid>
          </div>
        </div>
      ...
      return (
        <div>
          ...
          <div className="hero" style={{height: '61em'}}>
            <div className="container navbar">
              <img className="nav-logo" style={{height: '17px'}} src={require('../assets/logo.png')}></img>
              <div className="nav-items">
            ...
            <div className="container hero-view">
              <Grid container spacing={24}>
                <Grid item xs={12} sm={7} md={7} lg={7} xl={7} style={{paddingTop: '20px'}}>
                  ...
                  <div style={{margin: '50px 0'}}>
                    <input className="hero-input" style={{display: 'block', margin: '10px 0'}} placeholder="Book your training"></input>
                    <Button variant="contained" style={{display: 'block', margin: '10px 0', width: '220px'}} className="hero-button">Join a Group</Button>
                  </div>
                </Grid>
                <Grid item xs={12} sm={5} md={5} lg={5} xl={5}>
                  <img className="hero-image" style={{height: '40%', display: 'block', margin: 'auto'}} src={require('../assets/khalil-transparent.png')}></img>
                </Grid>
              </Grid>
            </div>
          </div>
      ...
      return (
        <div className="hero">
          ...
          <div className="container hero-view">
            <Grid container spacing={24}>
              <Grid item xs={12} sm={7} md={7} lg={7} xl={7} style={{paddingTop: '30px'}}>
                <div>
